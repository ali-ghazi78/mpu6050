...
void gyro_cal()
{
        ...
        g_x=(float)mpu6050_get_gyro_x();
        g_y=(float)mpu6050_get_gyro_y();
        g_z=(float)mpu6050_get_gyro_z()+120;
        ...
        //degree_x+=((float)g_x*(counter*256+(TCNT0))*TIME);//0.000000977022=;
        //degree_y+=g_y*(counter*256+(TCNT0))*TIME;//0.000000977022=TIME/GRYRO_SCALE;
